    ...
    stages {
        stage('Build') {
            parallel {
                ...
                stage('CppCheck') {
                    steps {
                        bat '"C:/Program Files/Cppcheck/cppcheck.exe" -j4 --enable=all --inline-suppr -I./src/ --suppress=variableScope --inconclusive --xml --xml-version=2 --force ./src 2> cppcheck.xml'
